...
const examples = [
  ...
  {
    name: 'Do Nothing',
    code: 'eyJtb3ZlWCI6InJldHVybiAwIiwibW92ZVkiOiJyZXR1cm4gMCIsInBsYWNlWCI6InJldHVybiAwIiwicGxhY2VZIjoicmV0dXJuIDAifQ=='
  },
  {
    name: 'Columns',
    code: ''
  }
];
